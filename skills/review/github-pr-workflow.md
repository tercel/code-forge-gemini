...
<sub>🤖 Generated with [Gemini CLI](https://gemini.google.com) · code-forge:review · 14 dimensions · {total_issues_posted} issues</sub>
```
...
<sub>🤖 Generated with [Gemini CLI](https://gemini.google.com) · code-forge:review</sub>
```
